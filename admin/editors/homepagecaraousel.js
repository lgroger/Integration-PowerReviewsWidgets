    ...
    Ext.widget({
        ...
        updateArrayData: function(sliderObject){
            ...
            if(arrayData.getValue().length > 0){
                ...
                for(i=0;i<arr.length;i++){
                    arr2.push(arr[i].id.replace(/[a-zA-Z]/g,""));
                }
                arr2 = arr2.map(Number);
                sliderObject.id = "UUID"+(Math.max.apply(null, arr2)+1);
        ...
        editHistoryDetails: function(id){
            ...
            var saveFn = function(){
                ...
                meThis.updateData(lineOne, lineTwo, lineThree, url, urlType, id,color);
                detailsWindow.close();
            };   
        ...
        updateData: function(lineOne, lineTwo, lineThree, url, urlType, id,color){
            var meThis = this;
