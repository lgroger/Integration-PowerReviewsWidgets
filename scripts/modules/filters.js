define(['modules/jquery-mozu', 'modules/api', 'hyprlive', 'modules/models-product', 'vendor/wishlist', 'vendor/jQuery.selectric'], function ($, api, Hypr, ProductModels, Wishlist, Selectric) {    
