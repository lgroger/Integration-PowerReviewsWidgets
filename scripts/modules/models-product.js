            ...
            this.whenReady(function () {
                if (!me.validate()) {
                    ...
                    me.apiAddToCart({
                        ...
                        me.trigger('addedtocart', item, me);
                    });
                }else{
                    $('[data-mz-validationmessage-for="quantity"]').html($('#mz-pdp-floating-header [data-mz-validationmessage-for="quantity"]').html());
                }
            });
        },
