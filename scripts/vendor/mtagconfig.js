// Date last modified =  20120423
// Modified by =  RK
// Added line 121 for displaying chat on the FAQ pages Ashwini Achar 04232013
// PK 06/06/2014 changed to using chat-shindigz-sales-product-english-3
...
try{
	if (typeof(lpUnit)=='undefined') { var lpUnit='shindigz-sales-checkout'; }
...
// LP Button Code
lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {'name':'chat-'+lpUnit+'-' + lpLanguage + '-3','pid':'lpchatbuttondiv','afterStartPage': true};
// added the line below per Reena Kevelson form live persons in order to display the chat banner in the FAQ pages. Added by Ashwini 04162013
lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {'name':'chat-'+lpUnit+'-' + lpLanguage + '-2','pid':'lpchatbutton2div','afterStartPage': true};